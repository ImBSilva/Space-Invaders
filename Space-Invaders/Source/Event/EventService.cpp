...
<<<<<<< Updated upstream:Space-Invaders/EventService.cpp
...
<<<<<<< HEAD:Space-Invaders/Source/Event/EventService.cpp
bool EventService::pressedLeftKey() { return game_event.key.code == sf::Keyboard::A || sf::Keyboard::Left;}
bool EventService::pressedRightKey() { return game_event.key.code == sf::Keyboard::D || sf::Keyboard::Right;}
=======
=======
>>>>>>> Stashed changes:Space-Invaders/Source/Event/EventService.cpp
>>>>>>> parent of ea33e57 (Revert "inplement namespaces"):Space-Invaders/EventService.cpp
